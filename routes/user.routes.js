...
router.route('/').get(protect, getUsers).post(protect, upload.single('image'), createUser)
router.route('/:id').get(protect, getUser).put(protect, upload.single('image'), updateUser).delete(protect, deleteUser)
